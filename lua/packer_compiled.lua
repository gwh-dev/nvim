...
_G.packer_plugins = {
  ...
  ["lsp_signature.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/gwh/.local/share/nvim/site/pack/packer/opt/lsp_signature.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'matchparen.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
