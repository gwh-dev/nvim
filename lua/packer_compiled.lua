...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp-signature-help", "cmp-nvim-lsp" },
  ...
  ["nvim-treesitter"] = {
    after = { "matchparen.nvim", "nvim-surround", "catppuccin" },
  ...
  ["vim-repeat"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/gwh/.local/share/nvim/site/pack/packer/opt/vim-repeat",
